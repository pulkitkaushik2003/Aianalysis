...
public class AiUserDataService implements UserDetailsService {
    ...
    private String resolveRepositoryError(Throwable ex) {
        ...
        if (message.contains("exception authenticating")
            ...
            return "Database authentication failed. Atlas username/password ya Database Access settings check karo.";
        }
        ...
        if (message.contains("timed out")
            ...
            return "Database connection abhi available nahi hai. Atlas network access aur URI check karo.";
        }
